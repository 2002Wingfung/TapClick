    ...
    protected void onStart() {
        ...
        for (final Widget e : appDescribe.widgetList) {
            ...
            View.OnClickListener widgetClickListener = new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (v == widgetBinding.widgetActionClick) {
                        e.action = Widget.ACTION_CLICK;
                        widgetBinding.widgetActionClick.setClickable(false);
                        widgetBinding.widgetActionBack.setClickable(true);
                        widgetBinding.widgetActionBack.setChecked(false);
                        widgetBinding.llClickProp.setVisibility(View.VISIBLE);
                    }
                    if (v == widgetBinding.widgetActionBack) {
                        e.action = Widget.ACTION_BACK;
                        widgetBinding.widgetActionBack.setClickable(false);
                        widgetBinding.widgetActionClick.setClickable(true);
                        widgetBinding.widgetActionClick.setChecked(false);
                        widgetBinding.llClickProp.setVisibility(View.GONE);
                    }
                    widgetSaveRun.run();
                }
            };
